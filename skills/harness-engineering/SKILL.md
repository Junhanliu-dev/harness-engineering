...
| `harness/skills/harness-coding/specs/{layer}.md` (one per layer) | `templates/skills/harness-coding-spec.md` |
...
Each layer spec is derived from reading 2-3 real files in that layer and extracting the common template, import rules, patterns, and anti-patterns.
